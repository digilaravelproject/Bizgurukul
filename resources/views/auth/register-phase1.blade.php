<x-guest-layout>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute inset-y-0 right-3 flex items-center" x-show="isLocked" x-cloak>
                            <button type="button"
                                @click="isLocked = false; showMasked = false; $nextTick(() => $el.closest('.relative').querySelector('input').focus())"
                                class="text-[10px] uppercase font-black bg-primary/10 text-primary px-3 py-1.5 rounded-lg hover:bg-primary hover:text-white transition-all duration-300 shadow-sm shadow-primary/20">
                                Change
                            </button>
                        </div>
                    </div>
    ...
    <div class="mt-8 space-y-4 text-center">
        <p class="text-[11px] text-mutedText font-bold uppercase tracking-wider">
