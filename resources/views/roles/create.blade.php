...
<div class="container-fluid font-sans antialiased">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 animate-fade-in">
        <div>
            <h2 class="text-2xl font-black text-mainText tracking-tight">Create New Role</h2>
            <p class="text-sm text-mutedText mt-1 font-medium">Define a role and select permissions for granular access control.</p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] border border-primary/10 shadow-xl overflow-hidden animate-fade-in">
        <form method="POST" action="{{ route('admin.roles.store') }}" class="p-8 md:p-12">
            @csrf
            ...
            <div class="pt-8 border-t border-primary/5">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h3 class="text-lg font-black text-mainText tracking-tight">Assign Permissions</h3>
                        <p class="text-xs text-mutedText font-medium mt-1">Select the tasks this role is allowed to perform.</p>
                    </div>
                </div>
            ...
            <div class="mt-12 pt-10 border-t border-primary/5 flex flex-col md:flex-row items-center gap-6 justify-between">
                <div class="flex items-center gap-3 text-mutedText font-medium">
                    ...
                    <p class="text-xs leading-none">All changes are tracked in activity logs.</p>
                </div>
                <button type="submit"
