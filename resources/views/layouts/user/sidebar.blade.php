<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="relative z-10 flex flex-col h-full bg-customWhite overflow-hidden">
                ...
                <a href="{{ route('student.dashboard') }}"
                    ...
                    @if (Storage::exists('site_images/logo1.png'))
                        <img src="{{ Storage::url('site_images/logo1.png') }}" alt="Logo"
                            class="h-full w-auto object-contain group-hover/logo:scale-105 transition-transform"
                            loading="lazy">
                    @else
        ...
        {{-- Sidebar Nav Menu (Ab yeh scrollable hai) --}}
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto no-scrollbar">
            ...
            <a href="{{ route('student.rewards') }}"
                class="flex items-center px-4 py-3 rounded-2xl transition-all duration-300 group {{ request()->routeIs('student.rewards*') ? 'bg-primary/10 text-primary shadow-sm' : 'text-mutedText hover:bg-navy hover:text-primary' }}">
                <i class="fas fa-trophy w-5 h-5 mr-3 flex items-center justify-center"></i>
                <span class="text-sm font-bold">My Rewards</span>
            </a>

            {{-- Leaderboard --}}
            <a href="{{ route('student.leaderboard') }}"
                class="flex items-center px-4 py-3 rounded-2xl transition-all duration-300 group {{ request()->routeIs('student.leaderboard*') ? 'bg-primary/10 text-primary shadow-sm' : 'text-mutedText hover:bg-navy hover:text-primary' }}">
                <i class="fas fa-crown w-5 h-5 mr-3 flex items-center justify-center"></i>
                <span class="text-sm font-bold">Leaderboard</span>
            </a>
            ...
            <a href="{{ route('student.resources') }}"
                class="flex items-center px-4 py-3 rounded-2xl transition-all duration-300 group {{ request()->routeIs('student.resources*') ? 'bg-primary/10 text-primary shadow-sm' : 'text-mutedText hover:bg-navy hover:text-primary' }}">
                <i class="fas fa-folder-open w-5 h-5 mr-3 flex items-center justify-center"></i>
                <span class="text-sm font-bold">Resources</span>
            </a>
            <p class="text-[10px] font-bold text-mutedText/50 uppercase tracking-[0.2em] px-4 mt-6 mb-2">Careers</p>
            {{-- Career Portal --}}
            <a href="{{ route('student.career_jobs.index') }}"
                class="flex items-center px-4 py-3 rounded-2xl transition-all duration-300 group {{ request()->routeIs('student.career_jobs*') ? 'bg-primary/10 text-primary shadow-sm' : 'text-mutedText hover:bg-navy hover:text-primary' }}">
                <i class="fas fa-briefcase w-5 h-5 mr-3 flex items-center justify-center"></i>
                <span class="text-sm font-bold">Career Portal</span>
            </a>
            ...
            <a href="{{ route('student.wallet.index') }}"
                ...
                <i class="fas fa-wallet w-5 h-5 mr-3 flex items-center justify-center"></i>
            ...
            <a href="{{ route('student.affiliate.commission_structure') }}"
                ...
                <i class="fas fa-sitemap w-5 h-5 mr-3 flex items-center justify-center"></i>
            ...
            <a href="{{ route('student.coupons.store') }}"
                ...
                <i class="fas fa-shopping-cart w-5 h-5 mr-3 flex items-center justify-center"></i>
                <span class="text-sm font-bold">Coupon Store</span>
            </a>

            {{-- Community Hub --}}
            <a href="{{ route('student.communities') }}"
                class="flex items-center px-4 py-3 rounded-2xl transition-all duration-300 group {{ request()->routeIs('student.communities*') ? 'bg-primary/10 text-primary shadow-sm' : 'text-mutedText hover:bg-navy hover:text-primary' }}">
                <i class="fas fa-users w-5 h-5 mr-3 flex items-center justify-center"></i>
                <span class="text-sm font-bold">Community Hub</span>
            </a>

            <p class="text-[10px] font-bold text-mutedText/50 uppercase tracking-[0.2em] px-4 mt-6 mb-2">Account &
                Billing</p>
        ...
        <div class="p-4 mt-auto border-t border-navy bg-navy/30 shrink-0">
