        ...
        <nav class="flex-1 p-4 space-y-1 overflow-hidden" x-data="{
            ...
            <div class="pt-4">
                ...
                <div x-show="lmsOpen" x-cloak x-transition class="ml-4 pl-4 mt-2 space-y-1 border-l-2 border-primary/20">
                    ...
                    <a href="{{ route('admin.beginner-guide') }}"
                        class="flex items-center gap-3 py-2 px-4 text-xs rounded-lg transition-all {{ request()->routeIs('admin.beginner-guide') ? 'text-primary font-bold bg-primary/5' : 'text-mutedText hover:text-primary' }}">
                    ...
                    <a href="{{ route('admin.resources') }}"
                        class="flex items-center gap-3 py-2 px-4 text-xs rounded-lg transition-all {{ request()->routeIs('admin.resources') ? 'text-primary font-bold bg-primary/5' : 'text-mutedText hover:text-primary' }}">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        Resources
                    </a>
                </div>
            ...
            <div class="pt-4">
                ...
                <div x-show="userOpen" x-cloak x-transition class="ml-4 pl-4 mt-2 space-y-1 border-l-2 border-primary/20">
                    ...
                    <a href="{{ route('admin.verifications.index') }}"
                        class="flex items-center gap-3 py-2 px-4 text-xs rounded-lg transition-all {{ request()->routeIs('admin.verifications.*') ? 'text-primary font-bold bg-primary/5' : 'text-mutedText hover:text-primary' }}">
            ...
            <div class="pt-4" x-data="{ affiliateOpen: {{ request()->routeIs('admin.affiliate.*') ? 'true' : 'false' }} }">
                ...
                <div x-show="affiliateOpen" x-cloak x-transition class="ml-4 pl-4 mt-2 space-y-1 border-l-2 border-primary/20">
                    ...
                    <a href="{{ route('admin.payouts.index') }}"
                        class="flex items-center gap-3 py-2 px-4 text-xs rounded-lg transition-all {{ request()->routeIs('admin.payouts.*') ? 'text-primary font-bold bg-primary/5' : 'text-mutedText hover:text-primary' }}">
