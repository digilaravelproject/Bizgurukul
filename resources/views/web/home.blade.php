...
<div class="relative overflow-hidden bg-navy text-mainText font-sans" x-data="homepageConfig()">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center gap-16">
            <div class="w-full lg:w-1/2 text-left animate-fade-in-down z-20">
                ...
                <div class="flex flex-col sm:flex-row gap-4 mb-12">
                    <a href="#bundles" class="px-8 py-4 rounded-xl brand-gradient text-white font-bold hover:shadow-lg hover:shadow-primary/30 hover:-translate-y-0.5 transition-all duration-300 text-center flex items-center justify-center gap-2">
                        Explore Catalog
    ...
    <section class="py-16 bg-surface relative" x-data="statsCounter()" x-intersect.once="startCounters()">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-gray-100 bg-navy rounded-3xl p-6 md:p-8 border border-primary/10">
                ...
                <div class="text-center px-4">
                    <div class="text-3xl md:text-4xl font-black text-white bg-clip-text brand-gradient mb-1" x-text="stats.courses + '+'"></div>
                ...
                <div class="text-center px-4">
                    <div class="text-3xl md:text-4xl font-black text-white bg-clip-text brand-gradient mb-1" x-text="stats.years + '+'"></div>
    ...
    <section class="py-20 bg-navy relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-12">
                <h2 class="text-3xl md:text-4xl font-black text-mainText mb-3">Why Top Performers Choose Us</h2>
                <p class="text-base text-mutedText">We've engineered an ecosystem focused entirely on your practical, real-world success.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="bg-surface border border-gray-100 rounded-2xl p-6 hover:-translate-y-1.5 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
                    <div class="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center mb-4 text-primary group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <h3 class="text-base font-bold text-mainText mb-2 group-hover:text-primary transition-colors">Lifetime Access</h3>
                ...
                <div class="bg-surface border border-gray-100 rounded-2xl p-6 hover:-translate-y-1.5 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
                    <div class="w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center mb-4 text-primary group-hover:bg-secondary group-hover:text-white transition-colors duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4L19 7"></path></svg>
                    </div>
                    <h3 class="text-base font-bold text-mainText mb-2 group-hover:text-secondary transition-colors">Industry Certified</h3>
                ...
                <div class="bg-surface border border-gray-100 rounded-2xl p-6 hover:-translate-y-1.5 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
                    ...
                    <h3 class="text-base font-bold text-mainText mb-2 group-hover:text-primary transition-colors">Expert Instructors</h3>
                ...
                <div class="bg-surface border border-gray-100 rounded-2xl p-6 hover:-translate-y-1.5 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 group">
                    ...
                    <h3 class="text-base font-bold text-mainText mb-2 group-hover:text-secondary transition-colors">24/7 Support</h3>
    ...
    <section id="how-it-works" class="py-16 bg-surface overflow-hidden relative border-y border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-12">
                <h2 class="text-3xl md:text-4xl font-black text-mainText mb-3">Your Path to Mastery</h2>
                <p class="text-base text-mutedText">Four simple steps separating you from your potential future.</p>
            </div>

            <div class="relative mt-8">
                <div class="hidden md:block absolute top-8 left-[10%] right-[10%] h-0.5 brand-gradient opacity-30"></div>

                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                    <div class="text-center relative group">
                        <div class="w-16 h-16 mx-auto bg-surface rounded-full flex items-center justify-center border-4 border-navy group-hover:border-primary shadow-md mb-3 relative z-10 font-black text-xl text-primary transition-all duration-300 group-hover:scale-110">1</div>
                        <h3 class="text-base font-bold text-mainText mb-1">Sign Up</h3>
                        <p class="text-mutedText text-xs">Create your free account instantly.</p>
                    </div>
                    <div class="text-center relative group md:translate-y-4">
                        <div class="w-16 h-16 mx-auto bg-surface rounded-full flex items-center justify-center border-4 border-navy group-hover:border-secondary shadow-md mb-3 relative z-10 font-black text-xl text-secondary transition-all duration-300 group-hover:scale-110">2</div>
                        <h3 class="text-base font-bold text-mainText mb-1">Choose Course</h3>
                        <p class="text-mutedText text-xs">Select the bundle that fits your goals.</p>
                    </div>
                    <div class="text-center relative group">
                        <div class="w-16 h-16 mx-auto brand-gradient rounded-full flex items-center justify-center border-4 border-navy shadow-md shadow-primary/30 mb-3 relative z-10 font-black text-xl text-white transition-all duration-300 group-hover:scale-110">3</div>
                        <h3 class="text-base font-bold text-mainText mb-1">Learn & Practice</h3>
                        <p class="text-mutedText text-xs">Watch videos and master the skill.</p>
                    </div>
                    <div class="text-center relative group md:translate-y-4">
                        <div class="w-16 h-16 mx-auto bg-surface rounded-full flex items-center justify-center border-4 border-navy group-hover:border-primary shadow-md mb-3 relative z-10 font-black text-xl text-primary transition-all duration-300 group-hover:scale-110">4</div>
                        <h3 class="text-base font-bold text-mainText mb-1">Get Certified</h3>
                        <p class="text-mutedText text-xs">Pass the exam and start earning.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="bundles" class="py-20 bg-navy relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
                <div>
                    <h2 class="text-3xl font-black text-mainText mb-2">Ultimate Mastery Bundles</h2>
                    <p class="text-base text-mutedText max-w-2xl">Packaged for maximum value. Get the complete roadmap instead of just building blocks.</p>
                </div>
                <div class="hidden md:block">
                    <span class="px-3 py-1.5 bg-red-100 text-red-600 font-bold rounded-lg text-xs animate-pulse flex items-center gap-1.5">
                ...
                @forelse($bundles as $index => $bundle)
                    <div class="rounded-2xl border {{ $index === 1 ? 'border-primary shadow-xl shadow-primary/10 bg-surface lg:-translate-y-2 ring-2 ring-primary/10' : 'border-gray-200 hover:border-primary/50 group bg-surface hover:shadow-lg' }} p-5 transition-all duration-300 flex flex-col relative overflow-hidden">
                        ...
                        <div class="mb-5 relative z-10 flex-grow">
                            <h3 class="text-xl font-black text-mainText mb-2 line-clamp-1">{{ $bundle->title }}</h3>
                            <p class="text-mutedText text-sm line-clamp-2 leading-relaxed mb-4">{{ Str::limit(strip_tags($bundle->description), 80) }}</p>

                            <div class="flex items-center justify-between border-t border-gray-50 pt-3">
                                <div class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                                    <span class="text-sm font-bold text-mainText">{{ $bundle->courses_count ?? $bundle->courses->count() }} Premium Courses</span>
                                </div>
                            </div>
                        </div>

                        <a href="{{ route('bundles.show', $bundle->slug ?? $bundle->id) }}" class="w-full block py-3 text-center rounded-xl text-sm font-bold transition-all duration-300 mt-auto relative z-10 {{ $index === 1 ? 'brand-gradient text-white hover:shadow-md hover:shadow-primary/30 hover:-translate-y-0.5' : 'bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-colors' }}">
                            View Bundle Details
                        </a>
                    </div>
                @empty
                    <div class="col-span-full text-center py-10 bg-surface rounded-2xl border border-gray-100">
                        <p class="text-mutedText text-base">New bundles are currently being crafted. Check back soon!</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section class="py-20 bg-surface border-y border-gray-100" id="courses" x-data="{ activeTab: 'all' }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                ...
                <p class="text-base text-mutedText max-w-2xl mx-auto">Specific skills to solve specific problems. Choose your path below.</p>
            </div>
            ...
            <div class="flex flex-wrap justify-center gap-2.5 mb-10">
                <button @click="activeTab = 'all'" :class="{ 'bg-primary text-white shadow-md ring-2 ring-primary/20': activeTab === 'all', 'bg-white text-mainText border border-gray-200 hover:border-primary/50': activeTab !== 'all' }" class="px-4 py-2 rounded-full font-bold transition-all text-xs tracking-wide">All Courses</button>
                @foreach($uniqueCategories as $cat)
                <button @click="activeTab = '{{ $cat }}'" :class="{ 'bg-primary text-white shadow-md ring-2 ring-primary/20': activeTab === '{{ $cat }}', 'bg-white text-mainText border border-gray-200 hover:border-primary/50': activeTab !== '{{ $cat }}' }" class="px-4 py-2 rounded-full font-bold transition-all text-xs tracking-wide capitalize">{{ $cat }}</button>
                @endforeach
            </div>
    ...
    <section class="py-20 bg-surface border-y border-gray-100 relative overflow-hidden" x-data="{ activeSlide: 0, slides: [0, 1, 2] }">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <h2 class="text-3xl font-black text-mainText text-center mb-10">Stories from Our Graduates</h2>
                ...
                <div class="flex justify-center gap-2 mt-4">
                    <template x-for="slide in slides">
                        <button @click="activeSlide = slide"
                                :class="{ 'bg-primary w-6': activeSlide === slide, 'bg-gray-300 w-2 hover:bg-primary/50': activeSlide !== slide }"
                                class="h-2 rounded-full transition-all duration-300 pointer-events-auto" aria-label="Go to slide"></button>
                    </template>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-navy">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
                <h2 class="text-3xl font-black text-mainText mb-3">Frequently Asked Questions</h2>
                <p class="text-base text-mutedText">Everything you need to know about the product and billing.</p>
            </div>

            <div class="space-y-4" x-data="{ activeAccordion: null }">
                <div class="bg-surface border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300 hover:border-primary/30" :class="{ 'shadow-md border-primary/50 ring-1 ring-primary/5': activeAccordion === 1 }">
                    <button @click="activeAccordion = activeAccordion === 1 ? null : 1" class="w-full px-5 py-4 text-left flex justify-between items-center focus:outline-none">
                        <span class="font-bold text-mainText text-base" :class="{ 'text-primary': activeAccordion === 1 }">Do I get access to future updates?</span>
                        <div class="w-7 h-7 rounded-full flex items-center justify-center transition-colors duration-300" :class="{ 'bg-primary/10': activeAccordion === 1, 'bg-gray-50': activeAccordion !== 1 }">
                            <svg class="w-4 h-4 text-mutedText transform transition-transform duration-300" :class="{ 'rotate-180 text-primary': activeAccordion === 1 }" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </div>
                    </button>
                ...
                <div class="bg-surface border border-gray-200 rounded-2xl overflow-hidden transition-all duration-300 hover:border-primary/30" :class="{ 'shadow-md border-primary/50 ring-1 ring-primary/5': activeAccordion === 3 }">
                    <button @click="activeAccordion = activeAccordion === 3 ? null : 3" class="w-full px-5 py-4 text-left flex justify-between items-center focus:outline-none">
                        ...
                        <div class="w-7 h-7 rounded-full flex items-center justify-center transition-colors duration-300" :class="{ 'bg-primary/10': activeAccordion === 3, 'bg-gray-50': activeAccordion !== 3 }">
                            <svg class="w-4 h-4 text-mutedText transform transition-transform duration-300" :class="{ 'rotate-180 text-primary': activeAccordion === 3 }" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                        </div>
                    </button>
            ...
            <div class="text-center mt-8">
                <p class="text-sm text-mutedText font-medium">Still have questions? <a href="{{ route('web.contact') }}" class="text-primary font-bold hover:underline underline-offset-4">Contact support</a></p>
            </div>
        </div>
    </section>

    <section class="py-20 relative overflow-hidden bg-navy">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div class="mb-16">
                <h2 class="text-4xl md:text-5xl font-black text-mainText mb-4 tracking-tight">
                    Ready to Build Your <br/>
                    <span class="text-white bg-clip-text brand-gradient">Digital Empire?</span>
                </h2>
                <p class="text-lg text-mutedText mb-8 max-w-2xl mx-auto font-medium">
