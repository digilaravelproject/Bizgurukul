...
<body class="font-sans antialiased text-mainText bg-navy flex flex-col min-h-screen">
    ...
    <nav class="fixed top-0 left-0 w-full z-50 bg-surface shadow-sm border-b border-gray-100"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20 md:h-24">
                ...
                <div class="hidden lg:flex lg:items-center">
                    <div class="flex xl:space-x-8 lg:space-x-5 mr-8">

                        <a href="{{ route('home') }}"
                            class="text-sm font-bold uppercase tracking-wide relative group transition-colors py-2 {{ request()->routeIs('home') ? 'text-primary' : 'text-mainText hover:text-primary' }}">
                            Home
                            <span class="absolute bottom-0 left-0 h-0.5 bg-primary transition-all duration-300 rounded-full {{ request()->routeIs('home') ? 'w-full' : 'w-0 group-hover:w-full' }}"></span>
                        </a>

                        <a href="{{ route('web.about') }}"
                            class="text-sm font-bold uppercase tracking-wide relative group transition-colors py-2 {{ request()->routeIs('web.about') ? 'text-primary' : 'text-mainText hover:text-primary' }}">
                            About
                            <span class="absolute bottom-0 left-0 h-0.5 bg-primary transition-all duration-300 rounded-full {{ request()->routeIs('web.about') ? 'w-full' : 'w-0 group-hover:w-full' }}"></span>
                        </a>

                        <a href="{{ route('web.contact') }}"
                            class="text-sm font-bold uppercase tracking-wide relative group transition-colors py-2 {{ request()->routeIs('web.contact') ? 'text-primary' : 'text-mainText hover:text-primary' }}">
                            Contact
                            <span class="absolute bottom-0 left-0 h-0.5 bg-primary transition-all duration-300 rounded-full {{ request()->routeIs('web.contact') ? 'w-full' : 'w-0 group-hover:w-full' }}"></span>
                        </a>

                        <a href="{{ route('web.terms') }}"
                            class="text-sm font-bold uppercase tracking-wide relative group transition-colors py-2 {{ request()->routeIs('web.terms') ? 'text-primary' : 'text-mainText hover:text-primary' }}">
                            Terms
                            <span class="absolute bottom-0 left-0 h-0.5 bg-primary transition-all duration-300 rounded-full {{ request()->routeIs('web.terms') ? 'w-full' : 'w-0 group-hover:w-full' }}"></span>
                        </a>

                        <a href="{{ route('web.privacy') }}"
                            class="text-sm font-bold uppercase tracking-wide relative group transition-colors py-2 {{ request()->routeIs('web.privacy') ? 'text-primary' : 'text-mainText hover:text-primary' }}">
                            Privacy
                    ...
                    <div class="pl-8 border-l-2 border-gray-100 flex items-center gap-4">
                        @auth
                            <a href="{{ route('dashboard') }}"
                                class="px-6 py-2.5 rounded-xl brand-gradient text-white font-bold hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5 transition-all duration-300 flex items-center gap-2">
                                Dashboard
                        ...
                        @else
                            <a href="{{ route('login') }}" class="text-mainText hover:text-primary font-bold transition-colors">Log in</a>
                            <a href="{{ route('register') }}"
                                class="px-6 py-2.5 rounded-xl brand-gradient text-white font-bold hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5 transition-all duration-300">
                                Sign Up
                            </a>
                        @endauth
                    </div>
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200"
            ...
            class="lg:hidden absolute w-full bg-surface border-b border-gray-200 shadow-2xl" style="display: none;">
            <div class="px-6 pt-4 pb-8 space-y-2">

                <a href="{{ route('home') }}"
                    class="block px-4 py-3.5 rounded-xl text-base font-bold transition-all border {{ request()->routeIs('home') ? 'bg-primary/10 text-primary border-primary/20' : 'text-mainText border-transparent hover:bg-primary/5 hover:text-primary hover:border-primary/10' }}">
                    Home
                </a>

                <a href="{{ route('web.about') }}"
                    class="block px-4 py-3.5 rounded-xl text-base font-bold transition-all border {{ request()->routeIs('web.about') ? 'bg-primary/10 text-primary border-primary/20' : 'text-mainText border-transparent hover:bg-primary/5 hover:text-primary hover:border-primary/10' }}">
                    About Us
                </a>

                <a href="{{ route('web.contact') }}"
                    class="block px-4 py-3.5 rounded-xl text-base font-bold transition-all border {{ request()->routeIs('web.contact') ? 'bg-primary/10 text-primary border-primary/20' : 'text-mainText border-transparent hover:bg-primary/5 hover:text-primary hover:border-primary/10' }}">
                    Contact
                </a>

                <a href="{{ route('web.terms') }}"
                    class="block px-4 py-3.5 rounded-xl text-base font-bold transition-all border {{ request()->routeIs('web.terms') ? 'bg-primary/10 text-primary border-primary/20' : 'text-mainText border-transparent hover:bg-primary/5 hover:text-primary hover:border-primary/10' }}">
                    Terms & Conditions
                </a>
                ...
                <div class="pt-6 mt-4 border-t border-gray-100 flex flex-col gap-4">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="block text-center px-4 py-4 rounded-xl text-mainText border-2 border-gray-100 font-bold hover:bg-gray-50 hover:border-primary/30 transition-colors">
                            Log in
                        </a>
                        <a href="{{ route('register') }}" class="block text-center px-4 py-4 rounded-xl brand-gradient text-white font-bold shadow-lg shadow-primary/20">
                            Sign Up Free
                        </a>
                    @endauth
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 lg:gap-12">
                ...
                <div class="md:col-span-5 lg:col-span-4">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 rounded-full bg-navy border border-gray-200 flex items-center justify-center text-mutedText hover:bg-primary/10 hover:border-primary/30 hover:text-primary hover:-translate-y-1 transition-all duration-300">
                        ...
                        <a href="#" class="w-10 h-10 rounded-full bg-navy border border-gray-200 flex items-center justify-center text-mutedText hover:bg-secondary/10 hover:border-secondary/30 hover:text-secondary hover:-translate-y-1 transition-all duration-300">
                        ...
                        <a href="#" class="w-10 h-10 rounded-full bg-navy border border-gray-200 flex items-center justify-center text-mutedText hover:bg-gray-800 hover:border-gray-800 hover:text-white hover:-translate-y-1 transition-all duration-300">
                            <span class="sr-only">X (Twitter)</span>
                            <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.008 4.15H5.078z" /></svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="md:col-span-3 lg:col-span-2 lg:col-start-7">
                    ...
                    <ul class="space-y-4">
                        <li><a href="{{ route('home') }}" class="text-mutedText font-medium hover:text-primary flex items-center gap-2 group transition-colors">
                            <span class="w-1 h-1 rounded-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity"></span>Home</a>
                        </li>
                        <li><a href="{{ route('home') }}#bundles" class="text-mutedText font-medium hover:text-primary flex items-center gap-2 group transition-colors">
                            <span class="w-1 h-1 rounded-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity"></span>Courses</a>
                        </li>
                ...
                <div class="md:col-span-4 lg:col-span-3">
                    ...
                    <ul class="space-y-4">
                        <li><a href="{{ route('web.privacy') }}" class="text-mutedText font-medium hover:text-primary flex items-center gap-2 group transition-colors">
                            <span class="w-1 h-1 rounded-full bg-primary opacity-0 group-hover:opacity-100 transition-opacity"></span>Privacy Policy</a>
                        </li>
