        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <div class="mb-20">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <a href="#bundles" class="px-8 py-4 rounded-xl bg-surface text-mainText font-bold text-lg border border-gray-200 hover:border-primary/50 hover:bg-gray-50 transition-all shadow-sm">
                        Browse Courses
                    </a>
                </div>
            </div>
